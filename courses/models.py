...
class Module(models.Model):
    ...
    order = OrderField(blank=True, for_fields=['course'], verbose_name='ترتیب')
...
class Content(models.Model):
    ...
    order = OrderField(blank=True, for_fields=['module'], verbose_name='ترتیب')
...
class ItemBase(models.Model):
    ...
    def render(self):
        """ Render the content type to the template """
